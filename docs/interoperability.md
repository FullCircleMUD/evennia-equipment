...
**Searching stays out of this library.** Resolving "wear the boots" against what a character is holding
is the command's job, using Evennia's own search over a candidate list these filters build. See
